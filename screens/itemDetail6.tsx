...
export default function ItemDetails({ navigation }: any) {
  ...
  return (
    <View style={styles.container}>
      <Image style={styles.img} source={require("../assets/images/pa.jpg")} />
      <View style={styles.profile}>
        ...
        <Text style={styles.mainArticle}>대파 같이 구매하실 분 계신가요?</Text>
        <Text style={styles.mainArticle}>대파 대량으로 구매하고 싶은데 인원 모집해서 상의해봐요!</Text>
        <Text style={styles.mainArticle}>모집기간 일주일 받을게요!</Text>
      </View>
      ...
      <View style={styles.down}>
        ...
        <TouchableOpacity style={styles.button} onPress={cntToggleState}>
          {cntToggle ? <Text style={styles.ppl}>1 / 2</Text> : <Text style={styles.ppl}>1 / 3</Text>}
        </TouchableOpacity>
      </View>
    </View>
  );
